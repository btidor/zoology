...
import ops
from common import BW, ByteArray, Instruction, State, uint256
...
if __name__ == "__main__":
    ...
    success, returndata = execute(
        instructions, jumps, BW(0), ByteArray("CALLDATA", b"\x6f\xab\x5d\xdf")
    )
    print("RETURN" if success else "REVERT", returndata)
